...
public class Account_type implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new Account_type and sets the default values.
     * @return a void
     */
    ...
    public static Account_type createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new Account_type();
    }
    /**
